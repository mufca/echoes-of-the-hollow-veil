...
public interface BookEvent {
    ...
    /**
     * Called before advancing to the next step. Return true to allow transition, false to block it.
     */
    ...
    /**
     * Returns a new ObjectNode with updates made by this step. Returning null means no changes.
     */
    ...
    /**
     * Called to inject accumulated data from previous steps. Implementation should not modify the given ObjectNode.
     */
