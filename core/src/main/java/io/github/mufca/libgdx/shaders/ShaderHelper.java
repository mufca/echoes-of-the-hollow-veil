...
public class ShaderHelper {
     ...
     * @return a map of uniforms with two entries: "u_boundsMin" and "u_boundsMax" containing the bottom-right and
     * top-left corners of the actor in screen coordinates respectively
     */
     ...
     * @return a map of uniforms with four entries: "strokeTopStart", "strokeBottomStart", "strokeLength", and
     * "strokeWidth" containing the top-left and bottom-left corners of the actor in screen coordinates respectively,
     ...
     * <p>
     * This is needed because libGDX's coordinate system has the origin at the bottom left of the screen, but shaders
     * expect the origin to be at the top left of the screen.
     *
